...
const DANCE = exports.DANCE = [AUTH_URL, DANCE_CALLBACK];

const REQUESTS = exports.REQUESTS = [[REQUEST_TOKEN_URL, REQUEST_TOKEN_OPTS, REQUEST_TOKEN_RESPONSE, 'get oauth token'], [ACCESS_TOKEN_URL, ACCESS_TOKEN_OPTS, ACCESS_TOKEN_RESPONSE, 'get access token'], [USER_INFO_URL, USER_INFO_OPTS, USER_INFO_RESPONSE, 'get user info']];